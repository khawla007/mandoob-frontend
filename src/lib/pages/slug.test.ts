...
test('all platform routes are reserved', () => {
  const expected = '_next about account admin api apply blog company-setup contact estimate forgot-password invite knowledge-base legal login mfa pricing pro register reset-password signin t verify-otp'.split(' ');
