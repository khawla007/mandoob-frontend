...
**Out of scope:** all Tier B files (admin/_, pro Settings_/Edit\*/NewInvoice/RequestDocument, estimator/CostEstimator, leads/LeadKanbanBoard, MfaEnrollCard, contact page).
